...
const NewCategory = () => {
  ...
  return (
    <>
      <Container>
        <FormularioTitulo>{categoriaEditada ? "Editar Categoría" : "Nueva Categoría"}</FormularioTitulo>
        <Form onSubmit={handleSubmit(onSubmit)}>
          <ElementosFormulario>
            <CajaInputs>
              ...
              {errors.nombre && (
                <SpanMensaje variant="red">El Nombre es un campo requerido</SpanMensaje>
              )}
            </CajaInputs>
          ...
          <CajaBotones>
            <ContenedorBotones>
              {categoriaEditada ? (
                <>
                  <InputSubmit type="button" value="Guardar Edición" onClick={handleSubmit(onSubmit)} />
